...
# Nuevos cuadros de texto para Razón Social, NIT y Número de Factura
razon_social = st.text_input("Ingrese la **Razón Social / Nombre** del cliente:", key="razon_social")
...
def generar_whatsapp_message(razon_social_cliente, nit_cliente, num_factura, sub_desc, iva_val, rete_fuente_val, rete_iva_val, desc_pp_val, sub_neto_val, iva_neto_val, total_pagar_val):
    return f"""
¡Hola! Aquí está el resumen de la factura:

* **Razón Social / Nombre del Cliente:** {razon_social_cliente if razon_social_cliente else 'No especificado'}
...
whatsapp_message_final = generar_whatsapp_message(
    razon_social, nit, numero_factura, subtotal_descuento, iva,
